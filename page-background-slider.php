			...
			<div class="col-lg-12 col-sm-12 col-xs-12">
				<div id="primary" class="content-area">
					<main id="main" class="site-main">
						...
						<div class="row">
							<div class="col-lg-8 col-sm-12 menu-services">
								<div class="row">
						...
						<div class="row">
							<div class="col-lg-10 col-sm-12 news-blog">
								<div class="row">
									<div class="col-lg-4 col-sm-12 post_list">
										...
										// Display post thumbnail 1 (on the bottom of slider)
											...
											if ( $query3->have_posts() ) {
												...
												while ( $query3->have_posts() ) {
													$query3->the_post(); ?>
													<div class="col-lg-4 col-sm-12 col-xs-12 post_list_thumbnail">
													    <div class="thumbnail">
											...
											<?php //echo '<h4 style="border-bottom: 3px solid #1d7cbf;margin: 0.7rem 0 0.7rem 0;"><a href="' . esc_url(get_category_link($post_thumbnails_2)) . '">' . get_cat_name($post_thumbnails_2) . '</a></h4>'; ?>
												...
												if ( $query_4->have_posts() ) {
													...
													while ( $query_4->have_posts() ) {
														$query_4->the_post(); ?>
														<div class="col-lg-4 col-sm-12 post_list_thumbnail">
															<div class="thumbnail">
																<?php echo get_the_post_thumbnail(); ?>
																<div class="caption">
																	<h3><?php echo '<a href="' . esc_url(get_post_permalink()) . '">' . get_the_title() . '</a>' ;?></h3>
